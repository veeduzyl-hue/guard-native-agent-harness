...
Status: v0.5.0 release gate and tag preparation in progress.
...
- Merge the v0.5 release gate PR.
- Run the final pre-tag release gate on `main`.
- Create the `v0.5.0` tag only after the merged release gate passes.
