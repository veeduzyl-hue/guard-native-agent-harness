...
Future provider work can use this guide as a local reference point while keeping model-backed planning optional and policy-gated. PR 10C adds optional OpenAI planning, and PR 10D adds optional DeepSeek planning.
