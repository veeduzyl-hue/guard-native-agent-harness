...
PR 11E records the executed sandbox experiment in [Dependency Upgrade Sandbox Experiment](DEPENDENCY_UPGRADE_EXPERIMENT.md). Targeted dev-tooling upgrades were kept after full validation passed and `audit:summary` reported zero vulnerabilities.
